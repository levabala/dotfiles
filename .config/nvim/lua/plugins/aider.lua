return {
	...
	init = function()
		vim.g.aider_command = 'aider --model deepseek --dark-mode --code-theme monokai --test-cmd "tsc --noEmit -p ./tsconfig.json" --auto-test'
